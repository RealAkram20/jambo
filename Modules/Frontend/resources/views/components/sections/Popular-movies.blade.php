<div class="popular-movies-block section-wraper">
    <div class="d-flex align-items-center justify-content-between px-1 mb-2 pb-1 mb-md-4 pb-md-0">
        <h4 class="main-title text-capitalize mb-0 fw-medium">{{ $sectionHeading ?? __('sectionTitle.popular_movies') }}</h4>
        @if (isset($viewAllBtn))
            <a href="{{ route('frontend.rail_archive', 'popular-movies') }}" class="text-primary iq-view-all text-decoration-none">{{ __('streamButtons.view_all') }}</a>
        @endif
    </div>
