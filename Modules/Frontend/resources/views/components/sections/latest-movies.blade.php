<div class="latest-block section-wraper">
    <div class="d-flex align-items-center justify-content-between px-1 mb-2 pb-1 mb-md-4 pb-md-0">
        <h4 class="main-title text-capitalize mb-0 fw-medium">{{ $sectionHeading ?? __('sectionTitle.latest_movies') }}</h4>
        @if (isset($viewAllBtn))
    ...
    <div class="card-style-slider">
        <div class="position-relative swiper swiper-card" data-slide="8" data-laptop="8" data-tab="4" data-mobile="3.5"
            ...
            <ul class="p-0 swiper-wrapper m-0 list-inline">
                @include('frontend::components.partials.section-cards', ['items' => $latestMovies ?? collect()])
            </ul>
