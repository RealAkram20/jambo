            ...
            <div class="row mt-5">
                ...
                <div class="col-xl-10 col-lg-9 mt-5 mt-lg-0">
                    <div class="tab-content" id="profile-menu-content">
                        <div class="tab-pane fade" id="playlist-tab-removed" role="tabpanel" style="display:none">
                            {{-- Playlist tab removed from sidebar — no user-playlist feature wired yet.
                                 The original tab markup below is left in place (hidden) until the whole
                                 profile-marvin page is replaced by the real /your-profile layout. --}}
                        ...
                        <div class="tab-pane fade show active" id="watchlist-tab" role="tabpanel">
                            <div class="col-md-12">
                                <div class="border-bottom mb-5 watchlist-tab">
                                    <div id="item-nav">
                                        <div class="item-list-tabs no-ajax css_prefix-tab-lists" id="object-nav">

                                            {{-- Watchlist Tabs — Movies and Series only. Video
                                                 and Episode tabs were template placeholders and
                                                 have been removed pending product decision. --}}
                                            <ul class="nav nav-underline data-search-tab" id="pills-tab" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link active" id="pills-movie-tab"
                                                        ...
                                                        <span class="text-muted small">({{ $watchlistMovies->count() }})</span>
                                                    </button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="pills-tvshow-tab" data-bs-toggle="pill"
                                                        ...
                                                        <span class="text-muted small">({{ $watchlistShows->count() }})</span>
                                                    </button>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="tab-content" id="pills-tabContent-watch">
                                    ...
                                    <div class="tab-pane fade active show" id="pills-movie1" role="tabpanel"
                                        ...
                                        <div class="row gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 data-listing">
                                            @forelse ($watchlistMovies as $item)
                                    ...
                                    <div class="tab-pane fade" id="pills-tvshow1" role="tabpanel" tabindex="0"
                                        ...
                                        <div class="row gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 data-listing">
                                            @forelse ($watchlistShows as $item)
                                                <div class="col" data-watchlist-row="{{ $item->id }}">
