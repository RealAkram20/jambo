    ...
    <div class="card-body">
        ...
        <div class="row g-3">
            <div class="col-md-8">
                ...
                <input type="url" class="form-control @error('poster_url') is-invalid @enderror" id="poster_url" name="poster_url" value="{{ old('poster_url', $season->poster_url) }}" placeholder="https://...">
