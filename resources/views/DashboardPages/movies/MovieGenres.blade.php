            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.genres.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="genre-name" name="name" placeholder="{{__('form.enter-title-genre')}}" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="genre-slug">{{__('form.slug')}}</label>
                        <input type="text" class="form-control" id="genre-slug" name="slug" placeholder="{{__('form.enter-slug-genre')}}">
                    </div>
